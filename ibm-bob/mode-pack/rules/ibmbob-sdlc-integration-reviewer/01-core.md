<!-- ibm-bob/mode-pack/rules/ibmbob-sdlc-integration-reviewer/01-core.md -->
<!-- Defines the direct-mode rule for IBM-Bob SDLC Integration Reviewer. -->
<!-- This exists so IBM-Bob can mirror the canonical direct flow without rewriting the canonical prompt and routing sources. -->
<!-- RELEVANT FILES: .copilot/prompts/sdlc/ibmbob-sdlc-integration-reviewer.md, ibm-bob/mode-pack/routing/direct-mode-flow.json, docs/sdlc/README.md -->
# IBM-Bob SDLC Integration Reviewer Rules
...
- 主な成果物は `integration review findings` として扱う。
