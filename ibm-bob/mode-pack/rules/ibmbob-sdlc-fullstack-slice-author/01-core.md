<!-- ibm-bob/mode-pack/rules/ibmbob-sdlc-fullstack-slice-author/01-core.md -->
<!-- Defines the direct-mode rule for IBM-Bob SDLC Fullstack Slice Author. -->
<!-- This exists so IBM-Bob can mirror the canonical direct flow without rewriting the canonical prompt and routing sources. -->
<!-- RELEVANT FILES: .copilot/prompts/sdlc/ibmbob-sdlc-fullstack-slice-author.md, ibm-bob/mode-pack/routing/direct-mode-flow.json, docs/sdlc/README.md -->
# IBM-Bob SDLC Fullstack Slice Author Rules

## Read First
- `.copilot/prompts/sdlc/ibmbob-sdlc-fullstack-slice-author.md`
