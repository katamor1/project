...
<!-- RELEVANT FILES: .copilot/prompts/sdlc/ibmbob-sdlc-basic-design-author.md, ibm-bob/mode-pack/routing/direct-mode-flow.json, docs/sdlc/README.md -->
...
- 主な成果物は `basic design artifact` として扱う。
