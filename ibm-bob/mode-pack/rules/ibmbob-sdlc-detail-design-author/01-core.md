...
<!-- RELEVANT FILES: .copilot/prompts/sdlc/ibmbob-sdlc-detail-design-author.md, ibm-bob/mode-pack/routing/direct-mode-flow.json, docs/sdlc/README.md -->
...
- 主な成果物は `detail design artifact` として扱う。
