<!-- ibm-bob/mode-pack/rules/ibmbob-legacy-search-gap-reporter/01-core.md -->
<!-- Defines the direct-mode rule for IBM-Bob Legacy Search Gap Reporter. -->
<!-- This exists so IBM-Bob can mirror the canonical direct flow without rewriting the canonical prompt and routing sources. -->
<!-- RELEVANT FILES: .copilot/prompts/legacy-search/ibmbob-legacy-search-gap-reporter.md, ibm-bob/mode-pack/routing/direct-mode-flow.json, docs/copilot-studio/legacy-search/README.md -->
# IBM-Bob Legacy Search Gap Reporter Rules
...
- 主な成果物は `safe-stop gap report` として扱う。
