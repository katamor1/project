<!-- ibm-bob/mode-pack/rules/ibmbob-sdlc-integration-bundle-planner/01-core.md -->
<!-- Defines the direct-mode rule for IBM-Bob SDLC Integration Bundle Planner. -->
<!-- This exists so IBM-Bob can mirror the canonical direct flow without rewriting the canonical prompt and routing sources. -->
<!-- RELEVANT FILES: .copilot/prompts/P15_integration_bundle_planner.md, ibm-bob/mode-pack/routing/direct-mode-flow.json, docs/sdlc/README.md -->
# IBM-Bob SDLC Integration Bundle Planner Rules

## Read First
- `.copilot/prompts/P15_integration_bundle_planner.md`
...
- 主な成果物は `integration bundle packet` として扱う。
