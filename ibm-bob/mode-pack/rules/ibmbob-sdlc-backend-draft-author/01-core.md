<!-- ibm-bob/mode-pack/rules/ibmbob-sdlc-backend-draft-author/01-core.md -->
<!-- Defines the direct-mode rule for IBM-Bob SDLC Backend Draft Author. -->
<!-- This exists so IBM-Bob can mirror the canonical direct flow without rewriting the canonical prompt and routing sources. -->
<!-- RELEVANT FILES: .copilot/prompts/sdlc/ibmbob-sdlc-backend-draft-author.md, ibm-bob/mode-pack/routing/direct-mode-flow.json, docs/sdlc/README.md -->
# IBM-Bob SDLC Backend Draft Author Rules

## Read First
- `.copilot/prompts/sdlc/ibmbob-sdlc-backend-draft-author.md`
...
- 主な成果物は `backend draft bundle` として扱う。
