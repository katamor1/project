<!-- ibm-bob/mode-pack/rules/ibmbob-sdlc-backend-codepack-author/01-core.md -->
<!-- Defines the direct-mode rule for IBM-Bob SDLC Backend Codepack Author. -->
<!-- This exists so IBM-Bob can mirror the canonical direct flow without rewriting the canonical prompt and routing sources. -->
<!-- RELEVANT FILES: .copilot/prompts/sdlc/ibmbob-sdlc-backend-codepack-author.md, ibm-bob/mode-pack/routing/direct-mode-flow.json, docs/sdlc/README.md -->
# IBM-Bob SDLC Backend Codepack Author Rules

## Read First
- `.copilot/prompts/sdlc/ibmbob-sdlc-backend-codepack-author.md`
