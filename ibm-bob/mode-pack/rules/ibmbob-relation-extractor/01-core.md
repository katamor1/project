<!-- ibm-bob/mode-pack/rules/ibmbob-relation-extractor/01-core.md -->
<!-- Defines the direct-mode rule for IBM-Bob Relation Extractor. -->
<!-- This exists so IBM-Bob can mirror the canonical direct flow without rewriting the canonical prompt and routing sources. -->
<!-- RELEVANT FILES: .copilot/prompts/runtime/ibmbob-relation-extractor.md, ibm-bob/mode-pack/routing/direct-mode-flow.json, docs/external-runtime/legacy-kb/README.md -->
# IBM-Bob Relation Extractor Rules
...
- 主な成果物は `relation edge bundle` として扱う。
