<!-- ibm-bob/mode-pack/rules/ibmbob-sdlc-test-draft-author/01-core.md -->
<!-- Defines the direct-mode rule for IBM-Bob SDLC Test Draft Author. -->
<!-- This exists so IBM-Bob can mirror the canonical direct flow without rewriting the canonical prompt and routing sources. -->
<!-- RELEVANT FILES: .copilot/prompts/sdlc/ibmbob-sdlc-test-draft-author.md, ibm-bob/mode-pack/routing/direct-mode-flow.json, docs/sdlc/README.md -->
# IBM-Bob SDLC Test Draft Author Rules

## Read First
- `.copilot/prompts/sdlc/ibmbob-sdlc-test-draft-author.md`
...
- 主な成果物は `test draft bundle` として扱う。
