<!-- ibm-bob/mode-pack/rules/ibmbob-sdlc-code-reviewer/01-core.md -->
<!-- Defines the direct-mode rule for IBM-Bob SDLC Code Reviewer. -->
<!-- This exists so IBM-Bob can mirror the canonical direct flow without rewriting the canonical prompt and routing sources. -->
<!-- RELEVANT FILES: .copilot/prompts/sdlc/ibmbob-sdlc-code-reviewer.md, ibm-bob/mode-pack/routing/direct-mode-flow.json, docs/sdlc/README.md -->
# IBM-Bob SDLC Code Reviewer Rules
...
- 主な成果物は `code review findings` として扱う。
