<!-- ibm-bob/mode-pack/rules/ibmbob-legacy-search-glossary-normalizer/01-core.md -->
<!-- Defines the direct-mode rule for IBM-Bob Legacy Search Glossary Normalizer. -->
<!-- This exists so IBM-Bob can mirror the canonical direct flow without rewriting the canonical prompt and routing sources. -->
<!-- RELEVANT FILES: .copilot/prompts/legacy-search/ibmbob-legacy-search-glossary-normalizer.md, ibm-bob/mode-pack/routing/direct-mode-flow.json, docs/copilot-studio/legacy-search/README.md -->
# IBM-Bob Legacy Search Glossary Normalizer Rules
...
- 主な成果物は `normalized legacy-search entities` として扱う。
