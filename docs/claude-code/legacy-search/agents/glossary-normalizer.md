<!-- docs/claude-code/legacy-search/agents/glossary-normalizer.md -->
<!-- This file contains the Claude Code workflow prompt for the LS-02 Glossary Normalizer agent. -->
<!-- This file exists to normalize business terms and aliases before document search starts. -->
<!-- RELEVANT FILES: docs/claude-code/legacy-search/shared-io-contract.yaml, docs/claude-code/legacy-search/agents/intake-router.md, docs/claude-code/legacy-search/agents/document-locator.md -->
