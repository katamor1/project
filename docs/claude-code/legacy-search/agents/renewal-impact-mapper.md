<!-- docs/claude-code/legacy-search/agents/renewal-impact-mapper.md -->
<!-- This file contains the Claude Code workflow prompt for the LS-07 Renewal Impact Mapper agent. -->
<!-- This file exists to translate verified current-state evidence into renewal review points. -->
<!-- RELEVANT FILES: docs/claude-code/legacy-search/shared-io-contract.yaml, docs/claude-code/legacy-search/agents/evidence-verifier.md, docs/claude-code/legacy-search/agents/change-diff-scout.md -->
