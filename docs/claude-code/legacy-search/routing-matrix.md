<!-- docs/claude-code/legacy-search/routing-matrix.md -->
<!-- This file defines the explicit v2 routing matrix for the Claude Code legacy search workflow pack. -->
<!-- This file exists so the team can operate the pack with Router-first entry and handoff packets. -->
<!-- RELEVANT FILES: docs/claude-code/legacy-search/shared-io-contract.yaml, docs/claude-code/legacy-search/README.md, docs/claude-code/legacy-search/pilot-runbook.md -->
# Routing Matrix
...
- `LS-02` 以降を単独で使った場合は通常処理をせず、`LS-01 Intake Router` へ戻します。
