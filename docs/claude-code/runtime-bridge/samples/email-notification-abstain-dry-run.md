<!-- docs/claude-code/runtime-bridge/samples/email-notification-abstain-dry-run.md -->
...
<!-- RELEVANT FILES: .copilot/schemas/entry-human-checkpoint.schema.json, .copilot/schemas/entry-response.schema.json, .copilot/prompts/C4_entry_response_shaper.md -->
...
```json
{
  ...
  "locale": "ja-JP",
  "session_context_ref": "thread://email-notify-abstain"
}
```
