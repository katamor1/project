...
<!-- This file defines the IBM Bob implementation guide for the legacy search prompt pack v2. -->
...
# IBM Bob Implementation Guide

## Agent Layout

- `ibmbob-legacy-search-intake-router` を唯一の入口にします。
