...
<!-- RELEVANT FILES: docs/sdlc/templates/functional-spec.md, .copilot/schemas/artifact-context-packet.schema.json, .copilot/prompts/K7_artifact_context_packer.md -->
# P2 Functional Spec Author
