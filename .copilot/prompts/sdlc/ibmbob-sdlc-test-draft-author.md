...
<!-- RELEVANT FILES: .copilot/schemas/test-draft-bundle.schema.json, .copilot/schemas/draft-file.schema.json, .copilot/prompts/sdlc/ibmbob-sdlc-integration-reviewer.md -->
# IBM Bob SDLC Test Draft Author
...
- `next_agent` は `ibmbob-sdlc-integration-reviewer` 固定です。
