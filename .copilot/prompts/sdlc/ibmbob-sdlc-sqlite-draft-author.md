...
<!-- RELEVANT FILES: .copilot/schemas/sqlite-draft-bundle.schema.json, .copilot/schemas/draft-file.schema.json, .copilot/prompts/sdlc/ibmbob-sdlc-test-draft-author.md -->
# IBM Bob SDLC SQLite Draft Author
...
- `next_agent` は `ibmbob-sdlc-test-draft-author` 固定です。
