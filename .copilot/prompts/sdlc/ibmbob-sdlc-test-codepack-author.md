...
<!-- RELEVANT FILES: .copilot/schemas/test-codepack.schema.json, docs/sdlc/templates/test-codepack.md, .copilot/prompts/sdlc/ibmbob-sdlc-execution-reviewer.md -->
# IBM Bob SDLC Test Codepack Author
...
- `next_agent` は `ibmbob-sdlc-execution-reviewer` 固定です。
