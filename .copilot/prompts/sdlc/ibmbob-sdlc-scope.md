...
<!-- RELEVANT FILES: .copilot/schemas/scope-packet.schema.json, .copilot/prompts/sdlc/ibmbob-sdlc-basic-design-author.md, docs/sdlc/templates/scope.md -->
# IBM Bob SDLC Scope
...
- `next_agent` は原則 `ibmbob-sdlc-basic-design-author` です。
