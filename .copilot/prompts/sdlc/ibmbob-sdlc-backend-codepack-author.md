...
<!-- RELEVANT FILES: .copilot/schemas/backend-codepack.schema.json, .copilot/schemas/sqlite-change-pack.schema.json, .copilot/prompts/sdlc/ibmbob-sdlc-test-codepack-author.md -->
# IBM Bob SDLC Backend Codepack Author
...
- `next_agent` は `ibmbob-sdlc-test-codepack-author` 固定です。
