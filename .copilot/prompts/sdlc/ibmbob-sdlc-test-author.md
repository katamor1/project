...
<!-- RELEVANT FILES: .copilot/schemas/test-pack.schema.json, .copilot/schemas/artifact-context-packet.schema.json, .copilot/prompts/runtime/ibmbob-artifact-context-packer.md -->
# IBM Bob SDLC Test Author
...
- `next_agent` は `ibmbob-sdlc-code-reviewer` 固定です。
