...
<!-- RELEVANT FILES: .copilot/schemas/backend-draft-bundle.schema.json, .copilot/schemas/draft-file.schema.json, .copilot/prompts/sdlc/ibmbob-sdlc-sqlite-draft-author.md -->
# IBM Bob SDLC Backend Draft Author
...
- `next_agent` は `ibmbob-sdlc-sqlite-draft-author` 固定です。
