...
<!-- RELEVANT FILES: .copilot/schemas/fullstack-slice.schema.json, docs/sdlc/templates/fullstack-slice.md, .copilot/prompts/sdlc/ibmbob-sdlc-test-author.md -->
# IBM Bob SDLC Fullstack Slice Author
...
- `next_agent` は `ibmbob-sdlc-test-author` 固定です。
