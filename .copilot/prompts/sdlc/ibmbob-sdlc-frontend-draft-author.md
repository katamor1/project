...
<!-- RELEVANT FILES: .copilot/schemas/frontend-draft-bundle.schema.json, .copilot/schemas/draft-file.schema.json, .copilot/prompts/sdlc/ibmbob-sdlc-backend-draft-author.md -->
# IBM Bob SDLC Frontend Draft Author
...
- `next_agent` は `ibmbob-sdlc-backend-draft-author` 固定です。
...
```json
{
  "prompt_id": "ibmbob-sdlc-frontend-draft-author",
  "prompt_version": "1.0",
