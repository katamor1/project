...
<!-- RELEVANT FILES: .copilot/schemas/review-findings.schema.json, .copilot/schemas/artifact-context-packet.schema.json, .copilot/prompts/runtime/ibmbob-evidence-reviewer.md -->
# IBM Bob SDLC Spec Reviewer
...
- `block` は `ibmbob-sdlc-request-orchestrator` に戻し、`human_checkpoint` を要求します。
...
```json
{
  "prompt_id": "ibmbob-sdlc-spec-reviewer",
  "prompt_version": "1.0",
  ...
  "next_agent": "ibmbob-sdlc-detail-design-author",
  "review_findings": {
    ...
    "findings": [],
    "revise_to": "ibmbob-sdlc-detail-design-author",
