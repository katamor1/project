...
<!-- RELEVANT FILES: .copilot/schemas/frontend-codepack.schema.json, docs/sdlc/templates/frontend-codepack.md, .copilot/prompts/sdlc/ibmbob-sdlc-backend-codepack-author.md -->
# IBM Bob SDLC Frontend Codepack Author
...
- `next_agent` は `ibmbob-sdlc-backend-codepack-author` 固定です。
