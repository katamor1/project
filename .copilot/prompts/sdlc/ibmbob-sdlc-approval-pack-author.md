...
<!-- RELEVANT FILES: .copilot/schemas/approval-pack.schema.json, docs/sdlc/templates/approval-pack.md, .copilot/prompts/sdlc/ibmbob-sdlc-review-record.md -->
# IBM Bob SDLC Approval Pack Author
...
- `next_agent` は `ibmbob-sdlc-review-record` 固定です。
