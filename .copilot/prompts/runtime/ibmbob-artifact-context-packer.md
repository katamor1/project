...
<!-- RELEVANT FILES: .copilot/schemas/artifact-context-packet.schema.json, .copilot/prompts/sdlc/ibmbob-sdlc-basic-design-author.md, .copilot/prompts/sdlc/ibmbob-sdlc-implementation-planner.md -->
# IBM Bob Artifact Context Packer
...
```json
{
  "prompt_id": "ibmbob-artifact-context-packer",
  "prompt_version": "1.0",
