...
<!-- RELEVANT FILES: docs/external-runtime/legacy-kb/eval-ops.md, .copilot/schemas/run-trace.schema.json, .copilot/routing/runtime/ibmbob-runtime-ingest-flow.yaml -->
# IBM Bob Runtime Eval Monitor
...
```json
{
  "prompt_id": "ibmbob-runtime-eval-monitor",
  "prompt_version": "1.0",
