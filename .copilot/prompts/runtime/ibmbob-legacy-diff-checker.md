...
<!-- RELEVANT FILES: .copilot/schemas/diff-report.schema.json, .copilot/prompts/runtime/ibmbob-evidence-reviewer.md, docs/external-runtime/legacy-kb/query-diff-flow.md -->
# IBM Bob Legacy Diff Checker
...
- `next_agent` は `ibmbob-evidence-reviewer` 固定です。
...
```json
{
  "prompt_id": "ibmbob-legacy-diff-checker",
  "prompt_version": "1.0",
