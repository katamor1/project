...
<!-- RELEVANT FILES: .copilot/schemas/execution-bundle-packet.schema.json, .copilot/schemas/target-repo-map.schema.json, .copilot/prompts/P11_frontend_codepack_author.md -->
# P10 Execution Bundle Planner
...
- `next_agent` は `P11_frontend_codepack_author` 固定です。
