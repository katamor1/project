...
<!-- This exists so confidence, ACL, authority, and Copilot-facing gate results are explicit before any P-lane execution starts. -->
<!-- RELEVANT FILES: .copilot/routing/legacy-kb-query-matrix.yaml, .copilot/routing/custom-engine-bridge-matrix.yaml, .copilot/prompts/C4_bridge_response_shaper.md -->
...
- `next_agent` は downstream `P*`, `P8`, `P9`, `K5`, `K0`, または `C4_bridge_response_shaper` です。
