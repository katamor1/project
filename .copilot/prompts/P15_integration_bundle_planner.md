...
<!-- RELEVANT FILES: .copilot/schemas/code-draft-packet.schema.json, .copilot/routing/integration-matrix.yaml, .copilot/prompts/P16_frontend_draft_author.md -->
# P15 Integration Bundle Planner
...
- `next_agent` は `P16_frontend_draft_author` 固定です。
