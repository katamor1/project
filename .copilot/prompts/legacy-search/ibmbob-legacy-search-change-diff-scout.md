...
<!-- This file contains the IBM Bob prompt for the ibmbob-legacy-search-change-diff-scout agent. -->
...
# ibmbob-legacy-search-change-diff-scout Prompt

## 役割

あなたは `ibmbob-legacy-search-change-diff-scout` です。
